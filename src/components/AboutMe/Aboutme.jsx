    ...
    <div ref={divRef} className="me-wrapper">
      <div className="me-division">
        ...
        <p ref={paraRef} className="me-para">
          Welcome to my website! My name is Sarang Jaybhaye, and I am Full Stack
          Web Developer. I created this website to share my passion and to
          connect with like-minded individuals.
        </p>

        <p ref={paraRef} className="me-para">
          <span style={{ color: "white" }}>A little bit about me:</span> For over 1.5 years, I've been living in Pune, India and working in the web field where I've gained knowledge about various topics such as networks, database management services, cloud computing, and more. This website is a way for me to share my knowledge and
